...
def test_shell_cmd_inputs_sep_4():
    ...
    shelly = ShellCommandTask(
        executable="executable", inpA=SplitArray(["aaa"]), input_spec=my_input_spec
    )
